        ...
        <div class="d-flex justify-content-around align-items-center">
            ...
            <div class="d-flex mt-2 ms-3">
                <form action="{{route('libro.buscador')}}" method="get">
                    <input type="text" class="p-2 text-gray-400 rounded border-1 border" name="texto" id="texto" placeholder="Título, Autor o Género" aria-label="Username" aria-describedby="basic-addon1">
                    <button class="btn mt-2 mb-2" style="background-color: rgb(34 197 94);color: white;">Buscar</button>
                </form>
                <a href="{{route('libro.index')}}"><button class="btn m-2" style="background-color: rgb(34 197 94);color: white;">Cancelar</button></a>
            </div>
        </div>
